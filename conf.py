...
copyright = u'2023, Artefactual Systems Inc.'
...
rst_epilog = """
.. |previous_version| replace:: 1.17
.. |previous_release| replace:: 1.17.1
"""
...
exclude_patterns = ['_build', '.env', '.git']
...
linkcheck_ignore = [
    ...
    # the parent page will have been removed in 1.16
    'https://www.archivematica.org/download/trac.tar.gz',
    # ignoring for now (1.15)
    # this page usually resolve, it should be a temporary fix.
    'http://gearman.org',
]
