...
.. _am-dashboard-config: https://github.com/artefactual/archivematica/blob/stable/1.18.x/src/archivematica/dashboard/install/README.md
.. _am-ldap-auth-mod: https://github.com/artefactual/archivematica/blob/stable/1.18.x/src/archivematica/dashboard/settings/components/ldap_auth.py
.. _am-shib-auth-mod: https://github.com/artefactual/archivematica/blob/stable/1.18.x/src/archivematica/dashboard/settings/components/shibboleth_auth.py
